...
def generate_launch_description():
    ...
    hri_face_detect_dir = get_package_share_directory("hri_face_detect")
    ...
    face_detect_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(hri_face_detect_dir, "launch", "face_detect.launch.py")
        )
    )
